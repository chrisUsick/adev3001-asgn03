...
public class Application {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (filename != null) {
            ...
            BreadthFirst breadthFirst = new BreadthFirst(mazeData.getMaze());
            Point startingPoint = mazeData.getStartingPoint();
            Stack<Point> solution = breadthFirst.breadthFirstSearch(startingPoint.getRow(), startingPoint.getColumn());
            if (solution.size() > 0) {
